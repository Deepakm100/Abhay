                        ...
                        <div>
                            <div className="mb-[0px]">
                                <div className="w-full mb-[0px]" >
                                    <DragIndicatorIcon className="relative text-gray-400 rotate-[-90deg] left-[300px]"  fontSize="small" />
                                </div>
                                <div>

                                    <Accordion onChange={() => { handleExpand(i) }} expanded={questions[i].open} className={questions[i].open ? "add_border border-l-6 border-blue-500" : ""}>
                                        <AccordionSummary aria-controls="panel1a-content" id="panel1a-header"
                                            elevation={1} className="w-full" >
                                            {!questions[i].open ? (
                                        ...
                                        <div className=" flex justify-center">  
                                            {!questions[i].answer ? (
                                              // add_question
                                                <AccordionDetails className="bg-white rounded-lg capitalize flex flex-col pt-0 w-11/12 px-[22px] py-[25px] ml-[10px]">
                                                  {/* add_question_top */}
